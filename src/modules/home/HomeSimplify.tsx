...
export const HomeSimplify: React.FC = () => {
	return (
		<section className="m-auto mt-[56px] flex w-full max-w-[1240px] flex-1 flex-col px-[20px] md:mt-10 md:px-0">
			<p className="w-[335px] text-[24px] leading-[31px] font-[400] text-[#242424] md:w-[600px] md:text-[28px] md:leading-[35px] lg:w-[831px]">
			...
			<div className="mt-[24px] grid min-h-[470px] grid-cols-1 items-start gap-[16px] lg:mt-[120px] lg:grid-cols-3 lg:gap-5">
