...
export const HomeWhyChoose: React.FC = () => {
    return (
        <section className="mb-[120px] w-full flex justify-between ">
            <div className="mt-[120px] max-w-[590px] mx-auto">
                <div className="md:max-w-[385px] flex flex-col gap-3 text-[#242424]">
                    <h3 className="text-[48px] font-[500] leading-[48px]">
                ...
                <div className="ml-[120px] mt-[64px] flex flex-col gap-10">
                    <div className="flex items-start gap-6">
                        <SquareV1Icon />
                        <div className="text-[#242424] flex flex-col gap-3  max-w-[380px]">
            ...
            <Image
                ...
                width={650}
                height={890}
                className="flex bg-no-repeat justify-end"
            />
        </section>
    );
};
