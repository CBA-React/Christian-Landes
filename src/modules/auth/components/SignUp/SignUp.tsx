            ...
            >
                <div className="flex flex-col">
                    ...
                    <input
                        {...register('fullName')}
                        type="text"
                        className="border border-[#24242480] p-[6px] w-full mt-[6px] placeholder:text-[#242424]"
                ...
                <div className="flex flex-col gap-4 mt-4">
                    <Button
                        ...
                        className="!bg-[#003BFF] !px-6 !py-3 !w-full justify-center"
                    >
                        Create Account
                    </Button>
                </div>
            </form>
            <article className="flex flex-col gap-5 mt-[20px]">
