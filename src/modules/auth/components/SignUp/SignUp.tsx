...
{showConfirmPassword ? <EyeOpen /> : <EyeClose />}
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            className="flex max-h-5 min-h-5 max-w-5 min-w-5 cursor-pointer appearance-none rounded border border-gray-400 checked:border-blue-600 checked:bg-blue-600 checked:before:relative checked:before:top-[0px] checked:before:left-[4px] checked:before:text-[13px] checked:before:text-white checked:before:content-['✔️']"
          />
